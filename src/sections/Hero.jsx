...
const Hero = () => {
  ...
  useGSAP(() => {
    ...
    tl.to(".fade-out", { opacity: 0, ease: "power1.inOut" })
      ...
      .to(".mask-wrapper", { maskSize: maskSize, ease: "power1.inOut" }, "<") //want to start this animation same time with previous
      .to(".mask-wrapper", { opacity: 0, maskPosition: maskPos })
      .to(
        ".overlay-logo",
        {
          opacity: 1,
